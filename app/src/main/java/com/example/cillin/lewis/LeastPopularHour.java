 ...
 */
public class LeastPopularHour extends ListActivity
{
    // Progress Dialog
    ...
    ArrayList<HashMap<String, String>> unpopularHour;

    // url to get all products list
    private static String url_popular_list = "http://192.168.1.4/food_api/least_popular_hour.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unpopularhour);

        // Hashmap for ListView
        unpopularHour = new ArrayList<HashMap<String, String>>();
    ...
    class LoadHours extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(LeastPopularHour.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter2 = new SimpleAdapter(
                            LeastPopularHour.this, unpopularHour,
                            R.layout.list_item5, new String[] {
                            TAG_DTIME, TAG_NAME},
                            new int[] { R.id.unpopularhour });
                    // updating listview
