 ...
 */
public class UnpopularStops extends ListActivity
{
    // Progress Dialog
    ...
    ArrayList<HashMap<String, String>> popularList;

    // url to get all products list
    private static String url_popular_list = "http://192.168.1.4/food_api/least_popular_stop.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.popularstops);
    ...
    class LoadStops extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(UnpopularStops.this);
            pDialog2.setMessage("Loading locations. Please wait...");
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter2 = new SimpleAdapter(
                            UnpopularStops.this, popularList,
                            R.layout.list_item3, new String[] {
                            TAG_NAME, TAG_DTIME},
                            new int[] { R.id.stop3 });
                    // updating listview
