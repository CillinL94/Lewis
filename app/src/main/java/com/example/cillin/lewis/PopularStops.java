 ...
 */
public class PopularStops extends ListActivity
{
    // Progress Dialog
    ...
    private static String url_popular_list = "http://192.168.1.4/food_api/most_popular_stop.php";
    ...
    class LoadStops extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog2 = new ProgressDialog(PopularStops.this);
